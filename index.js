...
// The way that code works is code can reach outside its own scope to grab a variable defined in an outside context, but not the other way around
...
const newCuboidTwo = new CuboidMakerTwo({
  length: 100,
  width: 100,
  height: 100
})
